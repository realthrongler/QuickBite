...
public class AdminHomeScreen extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AdminHomeScreen.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Incoming Orders");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(120, 110, 130, 22);
        ...
        jScrollPane1.setBounds(40, 150, 290, 130);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AdminHomeScreen().setVisible(true));
    }
